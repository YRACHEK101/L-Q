...
const BlogTitlePage = ({ params }: { params: { title: string } }) => {
  // récupérer les données du serveur en fonction des paramètres
  ...
  const renderContent = () => {
    return blog?.content.map((item, index) => {
      if (item.type === "text") {
        // Afficher le contenu texte en paragraphes séparés
        return (
        ...
        // Afficher les images avec un positionnement flexible
        return (
